...
const JewllDesignCard = ({ item }) => {
    ...
    return (
        <Link to={`/JewllDesign-details/${item?._id}`} className=" h-[220px]  md:h-56 lg:h-[255px] shadow-md border  rounded-md overflow-hidden transform transition-transform duration-200 hover:scale-105">
            <img src={item?.jewellImage[0]} alt="img" className="w-full h-[74%] md:h-[76%] object-cover  brightness-110 " />
