        ...
        <div className="flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-4 lg:p-4  bg-white w-full justify-center ">
            ...
            <div className="w-full md:w-1/2 lg:w-2/5 bg-white p-1 md:p-5 lg:p-6 md:rounded-lg md:shadow-md md:border">
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                    ...
                    <button type="submit" disabled={isLoading} className="w-full text-sm md:text-md bg-cyan-700 uppercase tracking-wider shadow font-semibold text-white py-1.5 lg:py-2 rounded-md hover:bg-cyan-800 hover:shadow-md transition-all duration-200">
