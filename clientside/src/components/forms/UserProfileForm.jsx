                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                    <div>
                        ...
                        <input {...register('email')} disabled
                            className="text-sm md:text-md mt-1 block w-full text-gray-500 p-1.5 md:p-2 border border-gray-300 rounded-md outline-none"
                        />
                    ...
                    <button type="submit" disabled={isLoading} className="w-full text-sm md:text-md bg-cyan-800 uppercase tracking-wider shadow font-semibold text-white py-1.5 lg:py-2 rounded-md hover:bg-cyan-900 hover:shadow-md transition-all duration-200">
